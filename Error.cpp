...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(113, "Ошибка разбора автоматом "),ERROR_ENTRY(114, "Превышен размер таблицы лексем"),ERROR_ENTRY(115, "Превышен размер таблицы идентификаторов"),
		ERROR_ENTRY(116, "Недопустимое значение литерала"),ERROR_ENTRY(117, "Превышена максимальная длина строки"),ERROR_ENTRY_NODEF(118),ERROR_ENTRY_NODEF(119),
